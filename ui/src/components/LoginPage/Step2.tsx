    ...
    <FullHeightContainer className={classes.root}>
      ...
      >
        ...
        <Box marginBottom="5em" alignContent="center">
          <Box component="h2" fontWeight="200">Glad to see you, Anthony! </Box>

          <Typography variant="h3" className={classes.Heading}>What's your email?</Typography>
      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={6}>
         <Box alignContent="right" marginTop="1em">
          ...
          <Button variant="outlined" size="medium" className={classes.SecondaryButton} component="button">Login without email</Button>
         </Box>
        </Grid>
        <Grid item xs={3}></Grid>
      </Grid>
